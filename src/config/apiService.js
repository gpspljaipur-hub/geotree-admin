...
export const apiService = {
  ...
  updateEmissionFactor: (data) => putAuth(ENDPOINTS.EMISSION_FACTOR_UPDATE, data),
  deleteEmissionFactor: (data) => deleteAuth(ENDPOINTS.EMISSION_FACTOR_DELETE, { data }),
  ...
  getCertificates: (data = { page: 1, limit: 10 }) => postAuth(ENDPOINTS.CERTIFICATES_LIST || ENDPOINTS.CERTIFICATE_LIST, data),
  ...
  deleteCertificate: (data) => deleteAuth(ENDPOINTS.CERTIFICATE_DELETE, { data }),
  getCertificateTemplates: (data = { page: 1, limit: 100 }) => postAuth(ENDPOINTS.CERTIFICATE_TEMPLATES_LIST, data),
  addCertificateTemplate: (data) => postAuth(ENDPOINTS.CERTIFICATE_TEMPLATE_ADD, data),
  updateCertificateTemplate: (data) => putAuth(ENDPOINTS.CERTIFICATE_TEMPLATE_UPDATE, data),
  deleteCertificateTemplate: (data) => deleteAuth(ENDPOINTS.CERTIFICATE_TEMPLATE_DELETE, { data }),
